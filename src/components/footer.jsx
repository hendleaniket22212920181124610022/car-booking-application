              ...
              <Col>
                <Row>
                  ...
                  <span>
                    ...
                    <a href="https://goo.gl/maps/2rkkAA9FP5pegCXF9" target="_blank" className="text-white">India</a>
                  </span>
                      <br/>
                      <span>
                    <BsTelephoneFill size="0.9em" className="header-line-2-icon"/>&nbsp;
                        <a href="tel:+12126583916" target="_blank" className="text-white">+91 8574968549</a>
                  </span>
                      <br/>
                      <span>
                    <GrMail className="header-line-2-icon"/>&nbsp;
                        <a href="mailto:aniket@gmail.com" target="_blank" className="text-white">aniket@gmail.com</a>
                  </span>
                    </p>
            ...
            <Row>
              <Col>
                <p className="text-white text-center fs-6 mt-2 mb-1">
                  {new Date().getFullYear()} All Rights Reserved. Developed & Designed by &nbsp;Aniket
                </p>
              </Col>
            </Row>
          </Container>
